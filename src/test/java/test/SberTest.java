...
public class SberTest extends BaseTests {
    ...
    public void exampleScenario() throws InterruptedException {
        ...
        element7.sendKeys("Фамилия");

        Assertions.assertEquals("Фамилия", element7.getAttribute("value"));
        ...
        Assertions.assertEquals("Имя", elem8.getAttribute("value"));

        //Поле Отчество
        String xpathMiddleName = "//*[@data-name='middleName']";
        WebElement elem9 = driver.findElement(By.xpath(xpathMiddleName));
        elem9.sendKeys("Отчество");

        Assertions.assertEquals("Отчество", elem9.getAttribute("value"));
